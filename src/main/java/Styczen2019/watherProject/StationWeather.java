...
import com.fasterxml.jackson.annotation.JsonIgnoreProperties;
       /* Oznaczenia pól
        temp20cm-   Temperatura gruntu (20cm pod powierzchnią ziemi)
        temp2m-  Temperatura powietrza, 2m nad powierzchnią ziemi
        temp0m-  Temperatura jezdni
        temp5cm-   Temperatura  powietrza, 5cm nad powierzchnią ziemi
        wind_dir-  Kierunek wiatru
        wind_speed - Prędkość wiatru (m/s)
        precipitation -   Wielkość opadów (mm)
        measure_time -  Ostatni czasu pomiaru
...
//    public StationWeather(String temp20cm, String temp2m, String temp0m, String temp5cm, String wind_dir, String wind_speed, String precipitation, String measure_time) {
